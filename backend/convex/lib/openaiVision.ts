...
const SYSTEM_PROMPT = [
  ...
  "",
  "Rules:",
  "- Focus on the physical badge/name tag first, especially the largest name line(s).",
  "- Names are often split across two lines. Combine adjacent first/last name lines into personName when both are legible.",
  "- If only a first name or given-name pair is visible, return exactly that visible text; do not invent a surname.",
  "- For blurry, angled, or tiny badge text, lower confidence. Use >= 0.85 only when every character of the name is clearly readable.",
  "- Treat event/sponsor text such as Orange Slice, Orange DAO, AI Growth Hackathon, YC, or hackathon dates as rawText context, not as the person's employer unless it is explicitly printed as an organization/employer field.",
  "- Do not infer company or school from clothing brands, jacket logos, laptop stickers, or single-letter sponsor icons. Only set companyName/schoolName when the badge clearly labels it as an organization, employer, university, or school.",
